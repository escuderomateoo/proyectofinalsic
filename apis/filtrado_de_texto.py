...
def limpiar_texto(texto:str)->str:
    ...
    #Elimino acentos
    texto = unicodedata.normalize('NFD',texto)  #Separa las tildes de cada letra, por mas que 
    ...
    texto = re.sub(r'[^a-z0-9\s]','',texto) #Defino un cojunto de elementos a considerar, los cuales
...
def eliminar_stopwords(texto:str)->str:
    ...
    filtrado = [pala for pala in palabras if pala not in stopwords_es]  #lista de palabras sin 
                                                                        # las stopwords
